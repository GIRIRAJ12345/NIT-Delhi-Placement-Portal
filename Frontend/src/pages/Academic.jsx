...
const Academic = () => {
    ...
    return (
        <div className='flex flex-col flex-wrap justify-center items-center bg-white mx-auto'>
            ...
            <div className='flex md:flex-row flex-col items-center justify-evenly max-w-7xl m-14'>
                ...
                <div className='w-[40%] max-w-xl'>
                    <img src="https://ocs.iitd.ac.in/ocs/assets/img/features-2.png" alt='image'/>
                </div>
            </div>
